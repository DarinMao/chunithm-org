...
| :----------------- | :---------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~**PARADISE LOST** | ![PARADISE LOST map selection](images/plost-maps.png) | Each map has a predetermined pathway for unlocking items, only unlocking the first will let you unlock the second, etc. You will only see the first few items as you first start off on a map. Later items are revealed as you progress. |
| **NEW**~           | ![NEW map selection](images/new-maps.png)             | Each map's items are displayed in a 3x3 grid, and can be unlocked in any given order, so you can prioritize unlocking your favourite characters/items.                                                                                   |
...
<figure markdown="1">
![Map bonuses](images/map-bonus.png)
</figure>
...
![Map select screen](images/map-select.png)
...
![Map steps screen](images/map-steps.png)
...
![Map mission song screen](images/map-mission.png)
...
![Map mission song folder](images/map-mission-folder.png)
...
| :----------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Character Rank Boost Ticket          | ![Ticket image](images/tickets/character-boost.png)                                                                                                                                      | (x3/x6/x9/x12) the character EXP gained after each song in the set.                                                                                                                                                                                                                                                                |
| Master Play Ticket                   | ![Ticket image](images/tickets/master.png)                                                                                                                                               | Allows you to play Master difficulty charts without unlocking them (through clearing the Expert difficulty of the same chart).                                                                                                                                                                                                     |
| Ultima Play Ticket (NEW and up)      | ![Ticket image](images/tickets/ultima.png)                                                                                                                                               | Allows you to play Ultima difficulty charts.                                                                                                                                                                                                                                                                                       |
| WORLD'S END Play Ticket              | ![Ticket image](images/tickets/we.png)                                                                                                                                                   | Allows you to play [WORLD'S END](../intermediate/rating.md#worlds-end) charts.                                                                                                                                                                                                                                                     |
| Map Boost Ticket (2/3/4/6x)          | ![Ticket image](images/tickets/map-boost.png)                                                                                                                                            | Boosts the steps taken on the map by a specific multiplier, after bonus steps (e.g. from a given character or chart) have been applied. Multiplies character EXP gained by 3x. Additionally, it allows you to play Master, Ultima, and World's End charts. If you can, **use this by default** since it applies all other unlocks. |
| Character EXP Boost Ticket (Premium) | ![Ticket image](images/tickets/character-boost-premium.png)                                                                                                                              | (x3/x6/x9/x12) the character EXP gained after each song in the set. Also increases Avatar Gauge and Team Points. Additionally, it allows you to play Master, Ultima, and World's End charts.                                                                                                                                       |
| Character EXP Boost Ticket (Present) | ![Ticket image](images/tickets/character-boost-present-6.png)![Ticket image](images/tickets/character-boost-present-9.png)![Ticket image](images/tickets/character-boost-present-12.png) | (x3/x6/x9/x12) the character EXP gained after each song in the set. Also increases Team Points gained and allows you to play Master charts.                                                                                                                                                                                        |
...
<figure markdown="1">
![Failing while getting SS](images/ss-fail.png)
...
!!! mitsuyoshi "Mitsuyoshi Tip!"
    ...
    <figure markdown="1">
    ![Houjuu Nue](images/houjuu-nue.png)
    </figure>
